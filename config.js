...
const placeholderURL = "http://localhost:3000";
const injectedBookmarkletJs = minifiedBookmarkletJs.replaceAll(placeholderURL, EBS_URL);
bookmarkletLink.href = injectedBookmarkletJs;